...
export default function Form({ customers }: { customers: CustomerField[] }) {
  ...
  useEffect(() => {
    console.log("Updated state.errors:", state);
  }, [state]);
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue=""
              aria-describedby="customer-error" /** aria-describedby="customer-error": This establishes a relationship between the select element and the error message container.
