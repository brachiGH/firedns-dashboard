    ...
    <div className="p-6 bg-gray-800 text-gray-100 max-w-4xl mx-auto rounded-lg shadow-lg">
      ...
      <ul className="mb-6 space-y-3">
        <li className="flex items-start">
          <span className="inline-block bg-orange-400 rounded-full w-2 h-2 mt-2 mr-2"></span>
      ...
      <p className="text-gray-200 bg-orange-400 bg-opacity-10 p-4 border-l-4 border-orange-500 rounded-r">
